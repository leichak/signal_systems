...
# Define source files
SOURCE_FILES="main.c AnalogFilters.c DigitalFilters.c BilinearTransform.c Utils.c Filtering.c Tests.c FixedPoint.c"
...
gcc "$OUTPUT_DIR/supportLib.o" "$OUTPUT_DIR/pbPlots.o" -g3 -lm -fdiagnostics-color=always -g $SOURCE_FILES -o $OUTPUT_EXECUTABLE
